define([
    ...
    return React.createClass({
        ...
        checkErr: function (a, c) {
            if (isNaN(a)) { return 'Table amount must be set'; } else if (isNaN(c)) { return 'Cashout amount must be set'; }
            if (a < 1) { return 'Table amount must be at least 1'; } else if (c < 1) { return 'Cashout amount must be at least 1'; } else if (c < a) { return 'Cashout amount must be equal to or greater than table amount'; } else { return null; }
        },
