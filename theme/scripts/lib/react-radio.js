define([
    ...
    return React.createClass({
        ...
        update: function () {
            if (this.props.defaultValue && !this.props.value) { this.setSelectedRadio(this.props.defaultValue); }
        },

        change: function () {
            if (!this.props.value) { this.props.onChange(this.getSelectedRadio()); }
        },
                ...
                React.Children.map(this.props.children, function (child) {
                    ...
                    if (child.props.children) {
                        React.Children.map(child.props.children, function (child) {
                            if (child.props.onChange) { var childrenChange = child.props.onChange; }

                            _.extend(child.props, { onChange: function (e) {
                                e.stopPropagation();
                                if (childrenChange) { childrenChange(); }
                            } });
                        });
                    }
                    ...
                    if (self.props.value) {
                        if (child.props.value !== self.props.value) { newProps.disabled = true; } else {
