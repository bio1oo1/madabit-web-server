define(function () {
    ...
    ///https://github.com/moneypot/webserver/blob/master/theme/scripts/game-logic/script-controller.js\n\
    \n\
    ...
    //engine.placeBet(betInSatoshis, extraBetInSatoshis, autoCashOutInPercent);\n\
    \n\
    ...
    return "// zh_This strategy editor is in BETA mode, please\n\
    // exercise extreme caution and use exclusively at\n\
    // your own risk. No bets can or will be refunded in\n\
    // case of errors.\n\
    \n\
